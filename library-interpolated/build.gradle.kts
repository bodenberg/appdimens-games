...
android {
    namespace = "com.appdimens.games.interpolated"
    compileSdk = 37
...
mavenPublishing {
    coordinates(
        "io.github.bodenberg",
        "appdimens-games-interpolated",
        providers.gradleProperty("appdimens.version").orElse("3.0.0").get()
    )
    configure(AndroidSingleVariantLibrary())
    pom {
        name.set("AppDimens Games — Interpolated")
        description.set("Interpolated multi-anchor scaling strategy (isdp) for games.")
