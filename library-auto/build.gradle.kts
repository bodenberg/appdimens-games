...
android {
    namespace = "com.appdimens.games.auto"
    compileSdk = 37
...
mavenPublishing {
    coordinates(
        "io.github.bodenberg",
        "appdimens-games-auto",
        providers.gradleProperty("appdimens.version").orElse("3.0.0").get()
    )
    configure(AndroidSingleVariantLibrary())
    pom {
        name.set("AppDimens Games — Auto")
        description.set("Auto-adjust scaling strategy for game surfaces (asdp) — window/resize aware.")
