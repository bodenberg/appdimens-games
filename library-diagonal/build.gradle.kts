...
android {
    namespace = "com.appdimens.games.diagonal"
    compileSdk = 37
...
mavenPublishing {
    coordinates(
        "io.github.bodenberg",
        "appdimens-games-diagonal",
        providers.gradleProperty("appdimens.version").orElse("3.0.0").get()
    )
    configure(AndroidSingleVariantLibrary())
    pom {
        name.set("AppDimens Games — Diagonal")
        description.set("Screen-diagonal scaling strategy (dgsdp) for games.")
