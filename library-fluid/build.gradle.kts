...
android {
    namespace = "com.appdimens.games.fluid"
    compileSdk = 37
...
mavenPublishing {
    coordinates(
        "io.github.bodenberg",
        "appdimens-games-fluid",
        providers.gradleProperty("appdimens.version").orElse("3.0.0").get()
    )
    configure(AndroidSingleVariantLibrary())
    pom {
        name.set("AppDimens Games — Fluid")
        description.set("Fluid interpolation scaling strategy between min/max widths (fsdp) for games.")
