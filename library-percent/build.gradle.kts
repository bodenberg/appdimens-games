...
android {
    namespace = "com.appdimens.games.percent"
    compileSdk = 37
...
mavenPublishing {
    coordinates(
        "io.github.bodenberg",
        "appdimens-games-percent",
        providers.gradleProperty("appdimens.version").orElse("3.0.0").get()
    )
    configure(AndroidSingleVariantLibrary())
    pom {
        name.set("AppDimens Games — Percent")
        description.set("Percent / screen-fraction scaling strategy (psdp, space*) for games.")
